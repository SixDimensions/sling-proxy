...
public @interface OSGiService {
	 ...
	 * to identify where the implementations come from.  This would restrict 
	 * the what kind of implementations can be used.
	 * 
	 ...
	 * The default Value for this is 'Void.class' which indicates that this
	 * values is NOT to be used to find an Implementation
