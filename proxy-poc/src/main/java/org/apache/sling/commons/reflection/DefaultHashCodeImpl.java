 ...
 *    If the Object is not a Proxy Object, the class name of the Object 
 * 	  the implemented interfaces class name in ascending Order
 *    the Members hashCode value, evaluated in the members class name ascending 
 *        order.  If the value in NULL, a zero value is used.
 * 
...
public final class DefaultHashCodeImpl implements IHashCode {
	...
	/* (non-Javadoc)
	 * @see org.apache.sling.commons.reflection.IHashCode#hashCode(java.lang.Object)
	 */
	...
	private int calculate(List<Integer> list) {
		...
		/**
		 * We start at PrimaryNumber index 2 because:
		 *    0 - is only a placeholder
	...
	/**
	 * This will return NULL if both values are not null.  Otherwise it will return:
	 * 		 0 - if both are NULL or both have the same Object identity
	 * 		-1 - if 'o1' is NULL but 'o2' is not
	 *       1 - if 'o1' is not null but 'o2' is 
	 * @param o1 Object
	 * @param o2 Object
	 * @return see above
	 */
