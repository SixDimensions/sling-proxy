...
public final class SlingEnvironmentHelper {
	...
	/**
	 * Sets the System Properties for:
	 *    USER, PASSWORD, and REPO_URL
	 * to default values of:
	 *    admin, xxxxxx, http://kelleher.dyndns.org:4502
	 */
	...
	private static org.apache.sling.commons.log.internal.slf4j.LogConfigManager getConfigManager() {
		return 	(org.apache.sling.commons.log.internal.slf4j.LogConfigManager) 
